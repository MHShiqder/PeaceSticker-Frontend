    ...
    const createPayment = async () => {
      ...
      try {
        ...
        const response = await axios.post(
          `${
            import.meta.env.VITE_Stripe_Backend_Api
          }/create-payment-intent-peace`,
          { price, formData }
        );
      ...
      <div className="space-y-6 md:w-xl mx-auto mt-28">
        <Card className="border-blue-800">
          <CardHeader>
            ...
            <CardDescription>
              Easily finalize your order using our seamless payment process.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            {loading ? (
              ...
              >
                <CheckoutForm clientSecret={clientSecret} price={price} formData={formData} />
              </Elements>
            ) : (
              <Alert className="border-red-200 bg-red-50">
                <AlertCircle className="h-4 w-4 text-red-600" />

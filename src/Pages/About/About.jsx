...
export default function About() {
  ...
  return (
    <div className="h-[calc(100vh-48px)] overflow-hidden relative flex justify-center">
      {/* Scroll Container */}
      <div className=" teleprompter2 absolute w-full flex flex-col items-center ">
        <p className="font-bold md:text-3xl playfair-display text-primary text-center lg:w-[55%] leading-normal  " >
          {t("about")}
          <br />
